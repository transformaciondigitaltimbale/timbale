...
def transform_sheet_data_to_siigo_format(sheet_data):
    # Asumimos que sheet_data es el diccionario que contiene los datos de la hoja de cálculo
    row = sheet_data['values'][0]  # Tomamos la primera (y única) fila de datos

    # Creamos el diccionario con el formato requerido por Siigo
    siigo_data = {
        "type": "Customer",
        "person_type": "Person",
        "id_type": "13",  # Asumimos que siempre es 13, ajusta si es necesario
        "identification": row[0],  # Número de identificación
        "check_digit": "7",  # Este valor parece ser fijo en tu ejemplo, ajusta si es necesario
        "name": [
            row[6],  # Nombre
            row[7]   # Apellido
        ],
        ...
        "fiscal_responsibilities": [
            {
                "code": "R-99-PN"  # Asumimos este código, ajusta si es necesario
            }
        ],
        "address": {
            ...
            "city": {
                "country_code": "Co",
                "state_code": "19",  # Asumimos estos códigos, ajusta si es necesario
                "city_code": "19001"
            },
            "postal_code": "110111"  # Asumimos este código postal, ajusta si es necesario
        },
        "phones": [
            {
                "indicative": "57",
...
siigo_formatted_data = transform_sheet_data_to_siigo_format(sheet_data)
print(siigo_formatted_data)
